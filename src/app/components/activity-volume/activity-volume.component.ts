...
@Component({
  ...
  templateUrl: './activity-volume.component.html',
...
export class ActivityVolumeComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    let chart = am4core.create('activity-volume', am4charts.XYChart);
...
// Create series
    ...
    createAxisAndSeries('visits', 'Trades Bought', false, 'circle');
    createAxisAndSeries('views', 'Trades Sold', true, 'triangle');
    createAxisAndSeries('hits', 'Total Trades', true, 'rectangle');
...
// generate some random data, quite different range
  ...
  openModal() {
    ...
    // Create chart instance
    let chartModal = am4core.create('activity-volume-modal', am4charts.XYChart);
