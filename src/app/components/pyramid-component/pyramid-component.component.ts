import {Component, OnInit, AfterViewInit, NgZone, OnDestroy, Input, ViewChild} from '@angular/core';
...
export class PyramidComponentComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    this.zone.runOutsideAngular(() => {
      let mainContainer = am4core.create(this.ID1, am4core.Container);
...
//femaleSeries.sequencedInterpolation = true;
  ...
  openModal() {
    ...
    // Create chart instance
    let chart = am4core.create('chartdivPyramidModal', am4charts.XYChart);
